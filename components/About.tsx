        ...
        <div className="grid grid-cols-1 md:grid-cols-2 w-[80%] mx-auto gap-[6rem] items-center pt-[4rem]">
          ...
          <div>
              ...
              <div className="mb-[3rem] flex flex-col items-center ">
                  <p className="text-[19px] text-slate-300 w-[100%] tracking-tighter text-justify">
                  ...
                  <br></br>
                  <p className="text-[19px] text-slate-300 w-[100%] tracking-tighter text-justify">
                      I have a wide range of hobbies and passions that keep me happy and motivated when I am not working. From reading, exercising to enjoying nature, I am always seeking new experiences and love to keep myself engaged in new activities.
                  </p>
                  <br></br>
                  <p className="text-[19px] text-slate-300 w-[100%] tracking-tighter text-justify">
